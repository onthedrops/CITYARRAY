...
?>
<A HREF=/log.php?file=bt>Bluetooth</A>&nbsp;&nbsp;<A HREF=/log.php?file=web>Web</A>&nbsp;&nbsp;<A HREF=/log.php?file=sign>sign</A>&nbsp;&nbsp;<A HREF=/log.php?file=remote>remote</A>&nbsp;&nbsp;<A HREF=/log.php?file=remoteerr>Remote Error</A>&nbsp;&nbsp;<A HREF=/log.php?file=program>program</A>
<PRE>
<?php
	...
	if(isset($_REQUEST['file'])) {
		switch($_REQUEST['file']) {
			case "program": $file = "/var/log/program.log"; break;
