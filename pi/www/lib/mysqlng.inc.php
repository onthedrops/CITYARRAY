 ...
 *
 * Based on code written 1998-2000 NetUSE AG
 *                    Boris Erdmann, Kristian Koehntopp
 *
 * Updated 2007 for my homepage by Sheer
 * Updated 2020 for php v7 by Sheer
 *
 */ 
...
class SQLng {
  ...
  function SQL($host=null) {
//	if($_SESSION['db'])
//		$this->Host = $_SESSION['db'];
	if($host)
		$this->Host = $host;
  }
...
function equote($string, $autonull=true) {
        $this->connect();
        if(null === $string && $autonull)
                return "null";
        return "'" . mysqli_real_escape_string($this->Link_ID, $string) . "'";
  }
 ...
 //       $this->halt("pconnect($Host, $User, \$Password) failed.");
  ...
  function query($Query_String) {
    ...
    if ($Query_String == "")
       ...
       * like these: '$db = new KanSQL_Subclass;'
       */
      return 0;
